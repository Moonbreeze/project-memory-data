...
Define how context-curator behavior is authored in agent-context and delivered through ai-inst/opencode without target-repository scaffold files.

## Outcome

A delivery model exists for Claude, Codex, and Cursor bindings that reuses shared authoring sources and does not copy harness artifacts into target repositories.
