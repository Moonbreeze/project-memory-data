...
- Use planning-backlog and planning-topic-entry as the primary read surfaces for work-item planning because they stay bounded and same-project by default.
...
- runbook: work-item-dependency-planning-baseline
